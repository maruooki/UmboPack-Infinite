...
## Recommended Launcher: Prism Launcher

UmboPack Infinite is designed and tested with Prism Launcher and it is the recommended way to play.

Download Prism Launcher here:

https://prismlauncher.org/

### Already use CurseForge?

That's perfectly fine. CurseForge is supported and can import the pack as well. If you already have CurseForge installed, there is no need to switch launchers.

---

## Step 1: Download the Base Modpack
...
**Do not extract the ZIP file before importing it.**
